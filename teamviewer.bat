...
set "RELAY_TEMP=%TEMP%\Raidbox-TeamViewerQS-1.38.exe"
set "RELAY_URL=https://github.com/raidboxinformatique/assistance-raidbox/releases/download/v1.38/TeamViewerQS.Legacy.exe"
set "RELAY_SHA256=dec11d8118fd9df18f044d767294fe6bad196bc0d42178a4b2c1a683c64ddb83"
