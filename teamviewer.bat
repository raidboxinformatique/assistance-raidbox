...
set "RELAY_URL=https://github.com/raidboxinformatique/assistance-raidbox/releases/download/v1.37/TeamViewerQS.Legacy.1.exe"
set "RELAY_SHA256=b03cbaac410e1ad34d19d42d8d3eb51ca837905650b944194dbc82f0ad38370a"
