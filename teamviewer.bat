...
set "RELAY_TEMP=%TEMP%\Raidbox-TeamViewerQS-1.39.exe"
set "RELAY_URL=https://github.com/raidboxinformatique/assistance-raidbox/releases/download/v1.39/TeamViewerQS.Legacy.exe"
set "RELAY_SHA256=05384cadd485e5da6f8053a1e33d197b87e9c043536423b32a42f0e2480bab6f"
